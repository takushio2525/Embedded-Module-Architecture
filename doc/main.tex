...
\fancyhead[R]{\small\color{headerblue}Rev.\,3.3}
...
\newcommand{\docsubtitle}{Arduino対応 組み込みモジュールインターフェース設計パターン}
\newcommand{\docauthor}{Shiozawaooooooo}
\newcommand{\docversion}{3.3}
