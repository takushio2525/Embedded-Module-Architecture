...
この章では、温度センサーモジュールを一から作ります。第3章〜第7章で学んだ知識の総まとめです。
...
3フェーズモデルでは、各モジュールのupdate()はできるだけ速く返る必要があります。delay()を使うと他のすべてのモジュールが影響を受けるため、ModuleTimerを使ったノンブロッキング方式を徹底してください。
\end{cautionbox}
