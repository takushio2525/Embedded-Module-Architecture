% 付録A: クラスとは
\section*{付録A: C++クラスの基礎}
\label{sec:appendix_class}
\addcontentsline{toc}{section}{付録A: C++クラスの基礎}

この付録では、本編を読むために必要なC++クラスの基礎知識を解説します。
すでにクラスを理解している方は読み飛ばしてください。
...
大丈夫です。\texttt{virtual}の詳しい説明は本編の第3章「インターフェースで統一する」で、具体例を交えて解説します。ここでは「そういうキーワードがあるんだな」とだけ覚えておいてください。
...
\begin{itemize}
  ...
  \item \textbf{virtual} — 第3章で詳しく！
\end{itemize}
\end{notebox}

これだけ分かっていれば、本編を読み進められます。さあ、第1章に進みましょう！
