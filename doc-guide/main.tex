...
\input{sections/servo}
\input{sections/buzzer}
\input{sections/mpu6500}
\input{sections/display_board}
\input{sections/camera}
\input{sections/drivemotor}
\input{sections/chassis}
\input{sections/ble}
\input{sections/wifi}
