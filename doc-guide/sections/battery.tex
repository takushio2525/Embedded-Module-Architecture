% BatteryModule
\section{BatteryModule — ADC + 移動平均フィルタ}
...
struct BatteryConfig {
    ...
    uint16_t      adcResolution;       // ADC分解能（ESP32: 4095）
...
\begin{lstlisting}[style=cppstyle, caption={BatteryModule.cpp — update()}]
...
\texttt{update()}の冒頭で\texttt{getNowTime() < interval}なら即\texttt{return}するパターンは、
